...
### ⿣ REVISIÓN DE DOCUMENTOS (Revisor de Documentos)
...
### ⿤ APROBACIÓN POST-DOCUMENTOS (Abogado)
...
### ⿥ AGREGAR CDP (Administrador Técnico)
...
### ⿧ DATOS TÉCNICOS POST-APROBACIÓN (Administrador Técnico)
*Estado:* administracion_tecnica (permanece)
